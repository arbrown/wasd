...
I'm a big proponent of starting as simple (i.e. managed) as possible, and going more complex when you need more functionality. On [Google Cloud](https://cloud.google.com/?utm_campaign=CDR_0x145aeba1_default_b512474466&utm_medium=external&utm_source=blog) that means starting with a managed service like [Gemini Enterprise Agent Platform](https://cloud.google.com/products/agent-builder?utm_campaign=CDR_0x145aeba1_default_b512474466&utm_medium=external&utm_source=blog) where you can build a no-code agent, or deploy your code to a managed platform. [Cloud Run](https://cloud.google.com/run?utm_campaign=CDR_0x145aeba1_default_b512474466&utm_medium=external&utm_source=blog) is another compelling option for agents that are generally stateless and do basic tasks. 
...
Gemini is a fantastic choice for most agent brains, but sometimes, you might want to run an open-weight model (like [Gemma](https://cloud.google.com/blog/products/ai-machine-learning/gemma-4-available-on-google-cloud) 😉).  If you're going to host and manage the model yourself, there are good reasons to put it close to your agent logic. 
...
{{< figure src="/images/why-gke-agents/isolation.png" width="600px" title="Keep your agent code isolated." >}}
...
{{< figure src="/images/why-gke-agents/router.png" width="600px" title="Smart routing for smart agents." >}}
...
* Try an [Agent Sandbox Codelab](https://codelabs.developers.google.com/codelabs/gke/ai-agents-on-gke?utm_campaign=CDR_0x145aeba1_default_b512474466&utm_medium=external&utm_source=blog)
* Read more about [Agents on GKE](https://cloud.google.com/blog/products/containers-kubernetes/agentic-ai-on-kubernetes-and-gke)
